...
public class AboutA extends Activity {
	private Button btn_title_left, btn_title_right,btn_touser;
	...
	private void findViews() {
		...
		btn_touser = (Button) findViewById(R.id.btn_touser);
	...
	private void handleEvents() {
		txt_title_name.setText(string.titlebar_txt_title_about);
		...
		btn_touser.setOnClickListener(new OnClickEvent());
	...
	class OnClickEvent implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.btn_title_left:
				...
				break;
			case R.id.btn_touser:
				intent.setClass(AboutA.this, ToUserA.class);
			...
			case R.id.menu_linear_feedback:
				FeedbackAgent agent = new FeedbackAgent(AboutA.this);
			...
			case R.id.menu_linear_exit:
				fanguInsert.showpp(AboutA.this);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		// TODO Auto-generated method stub
		Intent intent = new Intent(AboutA.this, SettingsA.class);
		startActivity(intent);
		AboutA.this.finish();
